...
public class ResenaController {
    ...
    @Operation(summary = "Obtiene las reseñas realizadas por un usuario")
@ApiResponses(value = {
...
public ResponseEntity<List<Resena>> obtenerResenasPorUsuario(@PathVariable Long idUsuario) {
    List<Resena> lista = resenaService.getResenasPorUsuario(idUsuario);
    if (lista.isEmpty()) {
        return ResponseEntity.noContent().build();
    }
    return ResponseEntity.ok(lista);
